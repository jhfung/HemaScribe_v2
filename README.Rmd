...
When the package is installed, reference data files will be automatically downloaded from the [latest release](https://github.com/jhfung/HemaScribe/releases).  This is required for the package to function.  
